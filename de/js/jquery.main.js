$(document).ready(function(){
    ...
    $('.js-order-btn').on('click', function(){
		...
		if(formName){
          ...
          if(!($(this).hasClass('js-close'))){
			$('#js-order-popup').find('.popup__title').html('Anruf bestellen');
    ...
    var words = [
      ...
      "Ihr Schlüssel zur Zukunft",
      "Eigenes CMS mit IP-Telefonie",
